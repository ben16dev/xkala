...
extension WorkoutDay {
    ...
    /// Rocódromo / training: solo defaults conocidos o el autogenerado actual por categorías.
    private var isTrainingAutoDefaultSessionName: Bool {
        ...
        if let proposed = proposedAutoGeneratedSessionName,
           trimmed.compare(proposed, options: .caseInsensitive) == .orderedSame {
            return true
        }
